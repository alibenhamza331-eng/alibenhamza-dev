...
const translations = {
    fr: {
        ...
        'pricing.lead': 'Offres claires à partir de <strong>700 MAD</strong>. Hébergement GitHub Pages inclus, promo lancement pour les premiers clients, et même hors promo les prix restent bas pour des vitrines simples.',
        ...
        'pricing.footnote': 'Promo lancement : -15% pour les premiers clients (places limitées). Tarifs bas pensés pour des vitrines simples, même sans promo. Les demandes pro ou fonctionnalités sur mesure seront facturées plus cher après devis. Pages supplémentaires dès 180 MAD/page. URL en sous-domaine github.io (nom du dépôt).',
        'faq.title': 'FAQ',
    ...
    en: {
        ...
        'pricing.lead': 'Clear packages from <strong>700 MAD</strong>. GitHub Pages hosting included, a launch promo for the first clients, and even without the promo prices stay low because these are simple showcase sites.',
        ...
        'pricing.footnote': 'Launch promo: -15% for the first clients (limited slots). Low rates are for simple showcase sites even without the promo. Pro or custom requests are priced higher after your quote. Extra pages from 180 MAD/page. URL on github.io (repo name).',
        'faq.title': 'FAQ',
